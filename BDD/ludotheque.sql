...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 25 sep. 2020 à 19:23
...
(3, 'Tekken 7', 1, 't7.jpg', 'Tekken 7 est le septième épisode de la série de jeux de combat éponyme. Cet épisode comprend d\'anciens personnages de la série, mais également de nouvelles têtes telles que Katarina, Claudio et d\'autres encore...', 'Bandai Namco ', 'Combat '),
(4, 'Valorant', 1, 'val.jpg', 'Valorant, anciennement Project A, est un FPS tactique dans la veine de Counter Strike et de Team Fortress. Le jeu développé et édité par Riot Games proposera de nombreux personnages aux capacités uniques, différents modes de jeu et promet déjà des serveurs sans failles et un système anti-triche à la pointe de la technologie.', 'Riot Games ', 'FPS Tactique '),
(5, 'Legends of Runeterra', 1, 'rune.jpg', 'Legends of Runeterra (LoR) est un jeu de cartes de stratégie gratuit se déroulant dans le monde de LoL. LoR inclut des cartes inspirées de champions mythiques de LoL, ainsi que de nouveaux alliés et personnages issus des régions de Runeterra, possédant chacun leur propre style et atouts stratégiques.', 'Riot Games', 'Cartes'),
(6, 'Space Engineers', 1, 'space.jpg', 'La survie dans l\'espace ou sur des planètes étrangères est au cœur de Space Engineers qui vous propose une large gamme de ressources à récolter et d\'objets à construire, tout ça dans le but de survivre le plus longtemps possible au milieu du grand vide intersidéral.', 'Keen Software ', 'Gestion Création Simulation Survie ');
